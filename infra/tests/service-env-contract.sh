...
required=(
  ...
  REGISTERED_SCOPES SIGNING_KEY_BUCKET SIGNING_KEY_KMS_KEY JWKS_KEY_PREFIX
  AS_ISSUER LIFECYCLE_SA_EMAIL FINANCE_ABSOLUTE_MAX_AMOUNT SECURITY_EVENTS_SUBSCRIPTION
