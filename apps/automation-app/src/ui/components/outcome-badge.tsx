...
export function OutcomeBadge(props: { outcome: string; phase: string }): Element {
  ...
  return (
    <span className={`badge ${className}`} data-emphasis={className}>
...
function WarningIcon(): Element {
  return (
    <svg className="warning-icon" data-icon="warning" viewBox="0 0 16 16" width="14" height="14" aria-hidden="true">
      <path d="M8 1 L15 14 L1 14 Z" fill="none" stroke="currentColor" strokeWidth="1.5" />
      <path d="M8 6 L8 10" stroke="currentColor" strokeWidth="1.5" />
