  ...
  return (
    <main className="guide" data-page="guide">
      ...
      <section className="card" data-step="operate">
        ...
        <p>起きたことは<a href="/activity">アクティビティ</a>で見ます。Agent ごとに1枚のカードになり、「準備」「作業 1」「終了」の区切りが、できごとが起きた順に1行ずつ並びます。行の「動きを図で見る」でその区切りの動きが図で再生され、「できごとを読む」で1件ずつの記録が読めます。図と記録は同じ画面で切り替え、一度に出るのはどちらか一方です。</p>
      ...
      <section className="card" data-step="trouble">
        ...
        <dl>
          ...
          <dd>アクティビティの上にある「問題があったものだけ」を押すと、遮断や失敗のあった区切りだけが残ります。その「できごとを読む」を開くと、止められた行に「遮断」の印が付いています。</dd>
          <dt>図の動きが速くて追えない</dt>
          <dd>「一時停止」で止まり、「次へ」で1手ずつ進みます。「できごとを読む」に切り替えると、同じ手の記録を文章で読めます。</dd>
          <dt>箱の名前が分からない</dt>
          <dd>図の箱を押すと説明が出ます。再生の前は、図の横に登場人物の一覧が出ています。</dd>
