  ...
  return (
    <main className="guide" data-page="guide">
      ...
      <section className="card" data-step="describe">
        ...
        <p>手順と確認したいことと注意点は、1行に1つ書きます。動かしておきたい時間は分で書き、1分から1440分（24時間）までです。</p>
      ...
      <section className="card" data-step="operate">
        ...
        <p>終わった処理の流れは<a href="/activity">タイムライン</a>で見られます。Agent ごとにまとまり、ログインから、作業を書き、権限を尋ね、承認し、Agent が動くまでが1つの流れとして並びます。図の再生と、起きたことの一覧の両方が出ます。動いている最中のものは Agent の画面で見てください。</p>
        <p>画面の先頭の「この記録に出てくるもの」に、その記録に出てきたものの役割が並びます。名前・何をするところか・すること・しないこと の4つを書いています。図の箱を押しても同じ説明が出ます。</p>
        <p>図を再生すると、矢印の上にそのやり取りの名前が出て、関わった箱が光り、図の下の枠にどこからどこへ何をしたかの説明が出ます。図の隣には「この手で Agent が考えたこと」として、その手で読んだ指示、Agent 自身の言葉、選んだ Tool と引数、実行前に確かめたことが順に出ます。</p>
        <p>Authorization Platform の行を開くと、AI が作業をどう読み、何を提案し、それぞれの権限がなぜ許可され却下されたかが読めます。</p>
      </section>
      ...
      <section className="card" data-step="trouble">
        ...
        <dl>
          ...
          <dt>図の動きが速くて追えない</dt>
          <dd>再生の上にある「一時停止」で止まり、「次へ」で1つずつ進みます。止めた状態でも、隣の「この手で Agent が考えたこと」と下の一覧はいつでも読めます。</dd>
          <dt>Agent OP や Resource AS が何なのか分からない</dt>
          <dd>タイムラインの先頭の「この記録に出てくるもの」を開いてください。図の箱を押しても同じ説明が出ます。</dd>
        </dl>
      </section>
    </main>
  );
