  ...
  return (
    <main class="guide" data-page="guide">
      ...
      <section class="card" data-step="operate">
        ...
        <p>終わった処理は<a href="/activity">タイムライン</a>で選択し、「経路を再生」で確認できます。動いている最中のものは Agent の画面で見てください。</p>
      </section>

      <section class="card" data-step="monitor">
        <h2>ログ分析の判断を確認する</h2>
        <p><a href="/security">ログ分析モニター</a>では、受信からAI分析までの進捗、スコア、AIを呼び出した理由、人の確認待ち、状態変更の依頼結果を確認できます。自分の最新30件を5秒ごとに更新します。</p>
        <p>デモ環境ではAgentの画面の「異常系を試す」から実行失敗を要求できます。次の処理開始時に適用され、状態と実行ログに失敗が表示されます。</p>
      </section>
      ...
      <section class="card" data-step="trouble">
        ...
        <dl>
          ...
          <dt>タイムラインに何も出ない</dt>
          <dd>終わった処理だけを再生します。動いている最中のものは Agent の画面で見てください。</dd>
        </dl>
      </section>
    </main>
  );
